...
class BandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create band" do
    assert_difference('Band.count') do
      post bands_url, params: { band: { date_debut: @band.date_debut, n_menbers: @band.n_menbers, name: @band.name, type_band: @band.type_band } }
    end
  ...
  test "should update band" do
    patch band_url(@band), params: { band: { date_debut: @band.date_debut, n_menbers: @band.n_menbers, name: @band.name, type_band: @band.type_band } }
