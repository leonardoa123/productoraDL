...
class ConcertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concert" do
    assert_difference('Concert.count') do
      post concerts_url, params: { concert: { band_id: @concert.band_id, description: @concert.description, duration: @concert.duration, event_id: @concert.event_id, q_audience: @concert.q_audience } }
    end
  ...
  test "should update concert" do
    patch concert_url(@concert), params: { concert: { band_id: @concert.band_id, description: @concert.description, duration: @concert.duration, event_id: @concert.event_id, q_audience: @concert.q_audience } }
